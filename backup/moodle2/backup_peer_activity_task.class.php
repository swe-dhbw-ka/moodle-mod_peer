...
/** peer backup task that provides all the settings and steps to perform one complete backup of the activity
 *
 * @package     mod_peer
 * @category    backup
 ...
 */
require_once($CFG->dirroot . '/mod/peer/backup/moodle2/backup_peer_stepslib.php'); // Because it exists (must).
require_once($CFG->dirroot . '/mod/peer/backup/moodle2/backup_peer_settingslib.php'); // Because it exists (optional).

/**
 * Class backup_peer_activity_task
 *
 * @copyright   2016 Johannes Grün <gruen.jojo.development@gmail.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_peer_activity_task extends backup_activity_task {
     ...
     * @param object $content Content to encode links
     * @return content|mixed tgr
     */
