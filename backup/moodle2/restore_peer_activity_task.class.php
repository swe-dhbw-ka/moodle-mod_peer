...
/** Peer restore task that provides all the settings and steps to perform one complete restore of the activity
 *
 * @package     mod_peer
 * @category    backup
...
/**
 * Class restore_peer_activity_task
 *
 * @copyright   2016 Johannes Grün <gruen.jojo.development@gmail.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_peer_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('peer_submission', array('content'), 'peer_submission');
     ...
     * peer logs. It must return one array
