...
/** Capabilities of the peer activity module are defined here.
 *
 * @package     mod_peer
 * @category    access
...
$capabilities = array(
    ...
    // Ability to see that the peer exists, and the basic information
    ...
    // Ability to add a new peer to the course.
    ...
    // in the peer as the authors
    'mod/peer:submit' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/peer:emailnotifyreview' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
